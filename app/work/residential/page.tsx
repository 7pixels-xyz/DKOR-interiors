...
export default function ResidentialWorkPage() {
  ...
  const filteredProjects = PROJECTS_DATA.filter(
    (p) => p.category === 'Residential' || p.category === 'Penthouse' || p.category === 'Coastal'
  );
      ...
      <section className="relative h-[60vh] flex items-center justify-center pt-24 px-6 md:px-12 overflow-hidden bg-[#1A1A1A]">
        ...
        >
          ...
          <p className="text-white/70 text-lg font-light leading-relaxed">
            Discover our curated archive of high-end residential transformations, dedicated to material integrity and spatial harmony for the way you live.
          </p>
        </motion.div>
      </section>
