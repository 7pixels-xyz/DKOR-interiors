        ...
        <div className="flex items-center justify-between w-full gap-8">
          <Link href="/" className="group flex flex-col justify-center relative z-20 shrink-0">
            <img 
              ...
              alt="DKOR Interiors" 
              className={`h-8 md:h-10 w-auto object-contain transition-all duration-500 ${!scrolled ? 'brightness-0 invert opacity-100' : 'opacity-100'}`}
            />
          </Link>
          ...
          <div className="flex items-center space-x-4 shrink-0">
            ...
            <Link
              href="/contact"
              className={`group inline-flex items-center space-x-2 text-[10px] md:text-xs uppercase tracking-widest px-5 py-2.5 rounded-full transition-all duration-500 overflow-hidden relative ${
                scrolled 
